...
const ReservationItemLift = ({ item, index, onRemove, onChange, itemCategories, defaultBookedFromTime = '', defaultBookedToTime = '' }) => {
    ...
    return (
        <div className="bg-yellow-50 border border-gray-300 rounded-sm p-3 mb-3">
            <div className="grid grid-cols-[270px_520px_200px_170px] gap-4">
                {/* Column 1: Lift Info */}
                <div>
                    <h3 className="text-sm font-bold mb-2">LIFT - {item?.itemName || ''}</h3>
...
export default ReservationItemLift;
