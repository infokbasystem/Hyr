const accentClasses = {
    ...
    lime: 'group-hover:border-lime-500 group-hover:bg-lime-200 group-focus:border-lime-500 group-focus:bg-lime-200 group-focus-visible:border-lime-500 group-focus-visible:bg-lime-200 group-active:border-lime-500 group-active:bg-lime-300',
...
const accentBaseClasses = {
    ...
    lime: 'border-lime-400 bg-lime-50 text-lime-700',
