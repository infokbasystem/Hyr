...
const items = [
    ...
    { to: "/finance/tobeinvoiced", label: "Att fakturera", iconComponent: FileStack, leftMargin: "ml-12" },
    { to: "/finance/invoice/new", label: "Ny faktura", iconComponent: BadgeDollarSign },
